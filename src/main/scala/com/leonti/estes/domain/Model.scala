...
case class Dish(@Key("_id") id: Option[CompositeId], name: String, ingredients: List[List[Ingredient]], selectedIngredients: List[Ingredient], menus: List[String], price: String)
